...
public class Bear2 : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        Debug.Log("(1)" + ans1 + " (2)" + ans2 + " (3)" + ans3);
    ...
    public void TORF()
    {
        if (ans1 == res1 && ans2 == res2 && ans3 == res3)
        {
        ...
        {
            scoreOpen += PlayerPrefs.GetString("trueRateScore2") + "Level 2:　 正確率:" + trueRate + "%" + "\n\n";
            PlayerPrefs.SetString("trueRateScore2", scoreOpen);
            if (PlayerPrefs.GetFloat("EXtrueRate2") <= (trueRate + 10))
            {
                FeedCount = PlayerPrefs.GetInt("FeedCount") + 2;
                PlayerPrefs.SetInt("FeedCount", FeedCount);
                Debug.Log(PlayerPrefs.GetInt("FeedCount"));
            }
            EXtrueRate = trueRate;
            PlayerPrefs.SetFloat("EXtrueRate2", EXtrueRate);
        }
